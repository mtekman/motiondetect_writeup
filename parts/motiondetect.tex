...
\paragraph{The chart below \cref{chart:thresholds} is based upon the data in the short table. It takes the maximum averages for each image size and plots them against the image size, with error bars as standard deviation. It then plots a linear trendline, as well as a more relevant logarithmic trendline because the threshold for 0x0 image sizes should tend towards 0, and not have a y coefficient.}
\begin{figure}
	\vspace{-20pt}
	\begin{center}
...
%Talk about the equation and how it's meaningless.
